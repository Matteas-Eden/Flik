...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=999, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_ADC_sample, CY_INSTANCE_SHORT_NAME=Timer_ADC_sample, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Timer_ADC_sample, )
...
module top ;
	...
	wire [0:0] tmpOE__INV2_net;
	wire [0:0] tmpFB_0__INV2_net;
	wire [0:0] tmpIO_0__INV2_net;
	wire [0:0] tmpINTERRUPT_0__INV2_net;
	electrical [0:0] tmpSIOVREF__INV2_net;

	cy_psoc3_pins_v1_10
		#(.id("bb58aeed-52ca-4def-bbc6-43d1e7da9b32"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		INV2
		 (.oe(tmpOE__INV2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INV2_net[0:0]}),
		  .io({tmpIO_0__INV2_net[0:0]}),
		  .siovref(tmpSIOVREF__INV2_net),
		  .interrupt({tmpINTERRUPT_0__INV2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INV2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__INV1_net;
	wire [0:0] tmpFB_0__INV1_net;
	wire [0:0] tmpIO_0__INV1_net;
	wire [0:0] tmpINTERRUPT_0__INV1_net;
	electrical [0:0] tmpSIOVREF__INV1_net;

	cy_psoc3_pins_v1_10
		#(.id("d55d7d9b-5cdb-4e34-88c1-12325afff5e0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		INV1
		 (.oe(tmpOE__INV1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__INV1_net[0:0]}),
		  .io({tmpIO_0__INV1_net[0:0]}),
		  .siovref(tmpSIOVREF__INV1_net),
		  .interrupt({tmpINTERRUPT_0__INV1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__INV1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_70_11 Timer_ADC_sample (
        .reset(Net_12),
        .interrupt(Net_4573),
        .enable(1'b1),
        .trigger(1'b1),
        .capture(1'b0),
        .capture_out(Net_4577),
        .tc(Net_4578),
        .clock(Net_10));
    defparam Timer_ADC_sample.CaptureCount = 2;
    defparam Timer_ADC_sample.CaptureCounterEnabled = 0;
    defparam Timer_ADC_sample.DeviceFamily = "PSoC5";
    defparam Timer_ADC_sample.InterruptOnCapture = 0;
    defparam Timer_ADC_sample.InterruptOnTC = 1;
    defparam Timer_ADC_sample.Resolution = 16;
    defparam Timer_ADC_sample.SiliconRevision = "0";
    ...
    CyControlReg_v1_80 Direction_Control (
        .control_1(Net_4591),
        .control_2(Net_4592),
        .control_3(Net_4593),
        .control_0(Net_4594),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Direction_Control.Bit0Mode = 0;
    defparam Direction_Control.Bit1Mode = 0;
    defparam Direction_Control.Bit2Mode = 0;
    defparam Direction_Control.Bit3Mode = 0;
    defparam Direction_Control.Bit4Mode = 0;
    defparam Direction_Control.Bit5Mode = 0;
    defparam Direction_Control.Bit6Mode = 0;
    defparam Direction_Control.Bit7Mode = 0;
    defparam Direction_Control.BitValue = 0;
    defparam Direction_Control.BusDisplay = 0;
    defparam Direction_Control.ExtrReset = 0;
    defparam Direction_Control.NumOutputs = 2;

	wire [0:0] tmpOE__ADC_DEBUG_net;
	wire [0:0] tmpFB_0__ADC_DEBUG_net;
	wire [0:0] tmpIO_0__ADC_DEBUG_net;
	wire [0:0] tmpINTERRUPT_0__ADC_DEBUG_net;
	electrical [0:0] tmpSIOVREF__ADC_DEBUG_net;

	cy_psoc3_pins_v1_10
		#(.id("1cc27b8a-fdbc-42fc-a2e7-5d5f22d899da"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ADC_DEBUG
		 (.oe(tmpOE__ADC_DEBUG_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ADC_DEBUG_net[0:0]}),
		  .io({tmpIO_0__ADC_DEBUG_net[0:0]}),
		  .siovref(tmpSIOVREF__ADC_DEBUG_net),
		  .interrupt({tmpINTERRUPT_0__ADC_DEBUG_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ADC_DEBUG_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
